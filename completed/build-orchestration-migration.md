...
This file records the completed migration from the large shell orchestrator to
the Python workflow-oriented build front end. Current usage and ownership are
documented in [`docs/build-orchestration.md`](../docs/build-orchestration.md).
Optional planner and compatibility cleanup is tracked in
