...
- Stories 1.5 and 3.6 require human review before implementation and explicit acceptance of results before releasing dependents. Story 1.6 is the software contract acceptance gate; 2.4 is ABI approval. Passing tests alone cannot replace those decisions.
